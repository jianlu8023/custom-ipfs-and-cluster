...
var logger = logging.Logger("cmdutils")
...
func (ch *ConfigHelper) init() {
	logger.Debugf("initializing config add storage ")
	...
	man.RegisterComponent(config.Informer, cfgs.StorageInf)
